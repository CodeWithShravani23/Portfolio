  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <span className="dark:text-[#00ffff] text-[#0066ff]">Shravani Patil</span>
        </motion.h1>
        <motion.p
          variants={itemVariants}
        ...
        >
          Computer Science Student & Full-Stack Developer, Solving Real-World Problems with Scalable Web Solutions
        </motion.p>
        ...
        >
          ...
          <SecondaryButton
            onClick={() => {
              const link = document.createElement("a");
              link.href = resumePdf;
              link.download = "Shravani_Patil_Resume.pdf";
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }}
